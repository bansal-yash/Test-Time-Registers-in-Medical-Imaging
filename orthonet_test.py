...
register_neurons = torch.load(f"Trained_Models/orthonet_{MODEL}/register_neurons.pt")
...
img_dir = f"{IMAGE_PATH}/orthonet data/orthonet data"
...
test_dataset_no_ttr = OrthoNetDataset(test_df, img_dir, class_to_idx, model, ttr=False)
test_dataset_ttr = OrthoNetDataset(test_df, img_dir, class_to_idx, model, ttr=True)
...
classifier.load_state_dict(
    torch.load(
        f"Trained_Models/orthonet_{MODEL}/best_model_" + method + ".pth",
        map_location=device,
    )
)
